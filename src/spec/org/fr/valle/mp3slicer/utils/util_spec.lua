...
describe("util.seconds_to_time", function()
    it("convertit les secondes en format HH:MM:SS", function()
        assert.are.equal(util.seconds_to_time(3661), "01:01:01")
    end)

    it("convertit les secondes en format MM:SS", function()
        assert.are.equal(util.seconds_to_time(125), "00:02:05")
    end)

    it("gère les secondes inférieures à 60", function()
        assert.are.equal(util.seconds_to_time(45), "00:00:45")
    end)

    it("gère les secondes cas concret", function()
        assert.are.equal(util.seconds_to_time(147.572494), "00:02:27")
    end)
end)
